...
Next, if you take a look at contracts/, you should be able to find OKCWeb3Domains.sol:
...
Next, to deploy the contract we will use a Hardhat script. Inside scripts/ you will find OKCWeb3Domains.js

Run it with npx hardhat run scripts/Web3Domains.js

```
$ npx hardhat run scripts/OKCWeb3Domains.js
```
